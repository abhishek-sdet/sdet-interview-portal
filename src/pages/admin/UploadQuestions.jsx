    ...
    const handleUpload = async (e) => {
        ...
        try {
            ...
            const processedQuestions = uniqueNewQuestions.map(q => {
                ...
                if (sectionLower.includes('javascript') || sectionLower.includes('js')) {
                    dbSection = 'general';
                    dbSubsection = 'javascript';
                } else if (sectionLower.includes('java') || sectionLower.includes('python') || sectionLower.includes('database')) {
                    dbSection = 'elective';
